    ...
    return (
        <>
            <a href={linkRel} className="relative flex items-center justify-center group">
                <img src={linkIcon} alt={linkName} className="xl:w-5 xl:h-5 h-4.5 w-4.5 invert-100 xl:invert-50 group-hover:invert-100 transition-all duration-300 group-hover:scale-110" />
